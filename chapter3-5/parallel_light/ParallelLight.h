...
#ifndef LEARN_OPENGL_PARALLELLIGHT_H
#define LEARN_OPENGL_PARALLELLIGHT_H
...
class ParallelLight: public GLObject {
public:
    ParallelLight(const char *_title);
    ~ParallelLight() override;
...
#endif //LEARN_OPENGL_ParallelLight_H
