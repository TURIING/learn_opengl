...
#ifndef LEARN_OPENGL_SPOTLIGHTSOFT_H
#define LEARN_OPENGL_SPOTLIGHTSOFT_H
...
class SpotLightSoft: public GLObject {
public:
    SpotLightSoft(const char *_title);
    ~SpotLightSoft() override;
...
#endif //LEARN_OPENGL_SPOTLIGHTSOFT_H
